...
const Article1 = async ({params}: {params: {slug: string}}) => {
  ...
  const reqUrlArticle = `${process.env.BASE_URL}/api/articlemnews/${params.slug}?fields[0]=Title&fields[1]=Description&fields[2]=Subtitle&populate[ImageBlock]=ImageBlock&populate[Content][populate]=*`
